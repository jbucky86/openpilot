...
class LatControlTorque(LatControl):
  ...
  def update(self, active, CS, VM, params, last_actuators, steer_limited, desired_curvature, desired_curvature_rate, llk):
    ...
    if not active:
      ...
      pid_log.error = CarInterfaceBase.torque_from_lateral_accel_linear(error,
                                self.torque_params, error,lateral_accel_deadzone, friction_compensation=False, v_ego=CS.vEgo, 
                                g_lat_accel=0., lateral_jerk_desired=0.0)
